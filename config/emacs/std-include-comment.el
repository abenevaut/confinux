;;
;; .std-include-comment.el for  in /home/beneva_a/Desktop/lib/elisp
;; 
;; Made by Antoine
;; Login   <beneva_a@epitech.net>
;; 
;; Started on  Sun Sep 12 19:19:15 2010 Antoine
;; Last update Sun Sep 12 19:31:19 2010 Antoine
;;
...
(if (setq user-nickname (getenv "USER_NICKNAME"))
    t (setq user-nickname (user-full-name)))

(setq write-file-hooks (cons 'std-header-update write-file-hooks))
